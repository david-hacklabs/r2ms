					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td align="center" background="../images/cal-bg-head.jpg"
								height="35"><span class="heading">SimpleRisk DREAD Calculator</span></td>
						</tr>
						...
						<tr>
							<td align="left" style="padding-left: 10px; padding-right: 10px"
								...
								href="http://en.wikipedia.org/wiki/DREAD:_Risk_assessment_model"
								target="_blank">DREAD</a> vulnerability severity scores. DREAD
								is a classification scheme for quantifying, comparing and
								prioritizing the amount of risk presented by each evaluated
								threat. The DREAD acronym is formed from the first letter of
								each category below. DREAD modeling influences the thinking
								behind setting the risk rating, and is also used directly to
								sort the risks. The DREAD algorithm, shown below, is used to
											...
											<table width="336" border="0" align="right" cellpadding="0"
												...
												<tr bordercolor="#CCCCCC">
													<td background="../images/cal-bg.jpg"><span class="style2"
														style="background-repeat: no-repeat">&nbsp;&nbsp;DREAD
															Score</span></td>
												</tr>
												<tr>
                      ...
                      <?php view_dread_help(); ?> 
													...
													<td valign="top"><table width="336" border="0"
															...
															<tr bordercolor="#CCCCCC">
																<td width="329" background="../images/cal-bg.jpg"
																	...
																	style="background-repeat: no-repeat">&nbsp; Categories</td>
															</tr>
															<tr>
                                    ...
                                    <?php create_numeric_dropdown("DamagePotential", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							...
																							onClick="javascript:showHelp('DamagePotentialHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("Reproducibility", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('ReproducibilityHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("AffectedUsers", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('AffectedUsersHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("Discoverability", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('DiscoverabilityHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
												...
												<tr>
													<td align="center"><input type="button" name="dreadSubmit"
														id="dreadSubmit" value="Submit"
