...
<html>
<head>
<title>R2MS OWASP Calculator</title>
<link rel="stylesheet" type="text/css" href="../css/style.css">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<link href="../css/front-style.css" rel="stylesheet" type="text/css">
<script language="javascript" src="../js/basescript.js"
	type="text/javascript"></script>
<script language="javascript" src="../js/owasp_scoring.js"
	type="text/javascript"></script>
			...
			<tr>
				<td align="left" valign="top" bgcolor="#6B7782">
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						bgcolor="#FFFFFF">
						<tr>
							<td align="center" background="../images/cal-bg-head.jpg"
								height="35"><span class="heading">SimpleRisk OWASP Calculator</span></td>
						</tr>
						...
						<tr>
							<td align="left" style="padding-left: 10px; padding-right: 10px"
								height="35">This page provides a calculator for creating <a
								href="https://www.owasp.org/index.php/OWASP_Risk_Rating_Methodology"
								target="_blank">OWASP</a> vulnerability severity scores. You'll
								need to gather information about the threat agent involved, the
								attack they're using, the vulnerability involved, and the impact
								of a successful exploit on your business. There may be multiple
								possible groups of attackers, or even multiple possible business
								impacts. In general, it's best to err on the side of caution by
								using the worst-case option, as that will result in the highest
								overall risk.
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td><table border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td valign="top">
											<table width="336" border="0" align="right" cellpadding="0"
												cellspacing="0">

												<tr bordercolor="#CCCCCC">
													<td background="../images/cal-bg.jpg"><span class="style2"
														style="background-repeat: no-repeat">&nbsp;&nbsp;OWASP
															Score</span></td>
												</tr>
												<tr>
													<td style="padding-left: 5px; padding-right: 5px;"><table
												...
												<tr bordercolor="#CCCCCC">
													<td background="../images/cal-bg.jpg"><span class="style2"
														style="background-repeat: no-repeat">&nbsp;&nbsp;Help Desk</span></td>
												</tr>
												<tr>
                      ...
                      <?php view_owasp_help(); ?>
										...
										<td background="../images/separetor.jpg"><img
											src="../images/separetor.jpg"></td>
										<td valign="top"><table width="100%" border="0"
												...
												<tr>
													<td valign="top"><table width="336" border="0"
															...
															<tr bordercolor="#CCCCCC">
																<td width="329" background="../images/cal-bg.jpg"
																	bgcolor="#E6E2E1" class="style2"
																	style="background-repeat: no-repeat">&nbsp;&nbsp;&nbsp;Likelihood</td>
															</tr>
															<tr>
																<td style="padding-left: 5px;"><table width="100%"
                                    ...
                                    <?php create_numeric_dropdown("SkillLevel", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('SkillLevelHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("Motive", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('MotiveHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("Opportunity", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('OpportunityHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("Size", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('SizeHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("EaseOfDiscovery", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('EaseOfDiscoveryHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("EaseOfExploit", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('EaseOfExploitHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("Awareness", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('AwarenessHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("IntrusionDetection", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('IntrusionDetectionHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
															...
															<tr bordercolor="#CCCCCC">
																<td background="../images/cal-bg.jpg" bgcolor="#E6E2E1"
																	class="style2" style="background-repeat: no-repeat">&nbsp;&nbsp;&nbsp;Impact</td>
															</tr>
															<tr>
																<td style="padding-left: 5px;"><table width="100%"
																		border="0" cellpadding="1" cellspacing="1">
                                    ...
                                    <?php create_numeric_dropdown("LossOfConfidentiality", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('LossOfConfidentialityHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("LossOfIntegrity", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('LossOfIntegrityHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("LossOfAvailability", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('LossOfAvailabilityHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("LossOfAccountability", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('LossOfAccountabilityHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("FinancialDamage", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('FinancialDamageHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("ReputationDamage", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('ReputationDamageHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("NonCompliance", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('NonComplianceHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
                                    ...
                                    <?php create_numeric_dropdown("PrivacyViolation", 10, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('PrivacyViolationHelp');"></td>
																					</tr>
																				</table>
																			</td>
																		</tr>
												...
												<tr>
													<td align="center"><input type="button" name="owaspSubmit"
														id="owaspSubmit" value="Submit"
														onclick="javascript: submitandclose();" /></td>
												</tr>
												<tr>
