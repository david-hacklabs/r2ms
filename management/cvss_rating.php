...
<script language="javascript" src="../js/cvss_scoring.js"
	type="text/javascript"></script>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td align="center" background="../images/cal-bg-head.jpg"
								height="35"><span class="heading">SimpleRisk CVSS V2.0
									Calculator</span></td>
						</tr>
						...
						<tr>
							<td align="left" style="padding-left: 10px; padding-right: 10px"
								...
								href="http://www.first.org/cvss/" target="_blank">CVSS</A>
								vulnerability severity scores. The scores are computed in
								sequence such that the Base Score is used to calculate the
								Temporal Score and the Temporal Score is used to calculate the
								Environmental Score.
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td><table border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td valign="top">
											<table width="500" border="0" align="right" cellpadding="0"
												cellspacing="0">

												<tr bordercolor="#CCCCCC">
													<td background="../images/cal-bg.jpg"><span class="style2"
														style="background-repeat: no-repeat">&nbsp;&nbsp;CVSS
															Score</span></td>
												</tr>
												<tr>
                      ...
                      <?php view_cvss_help(); ?>
													...
													<td valign="top"><table width="336" border="0"
															...
															<tr bordercolor="#CCCCCC">
																<td width="329" background="../images/cal-bg.jpg"
																	...
																	style="background-repeat: no-repeat">&nbsp; Base Score
																	Metrics</td>
															</tr>
															<tr>
																<td style="padding-left: 5px;"><table width="100%"
																		...
																		<tr>
																			...
																			<td width="119"><table border="0" cellspacing="0"
																					cellpadding="0">
																					<tr>
																						<td>
                                    <?php create_cvss_dropdown("AccessVector")?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							...
																							onClick="javascript:showHelp('AccessVectorHelp');"></td>
																					</tr>
																				</table></td>
																		</tr>
																		<tr>
																			<td>Attack Complexity</td>
																			<td class=""><table border="0" cellspacing="0"
																					cellpadding="0">
																					<tr>
																						<td>
                                      <?php create_cvss_dropdown("AccessComplexity")?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('AccessComplexityHelp');"></td>
																					</tr>
																				</table></td>
																		</tr>
																		<tr>
                                      ...
                                      <?php create_cvss_dropdown("Authentication")?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('AuthenticationHelp');"></td>
																					</tr>
																				</table></td>
																		</tr>
																		<tr>
                                      ...
                                      <?php create_cvss_dropdown("ConfImpact")?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('ConfImpactHelp');"></td>
																					</tr>
																				</table></td>
																		</tr>
																		<tr>
                                      ...
                                      <?php create_cvss_dropdown("IntegImpact")?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('IntegImpactHelp');"></td>
																					</tr>
																				</table></td>
																		</tr>
																		<tr>
                                      ...
                                      <?php create_cvss_dropdown("AvailImpact")?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('AvailImpactHelp');"></td>
																					</tr>
																				</table></td>
																		</tr>
																	</table></td>
															...
															<tr bordercolor="#CCCCCC">
																<td background="../images/cal-bg.jpg" bgcolor="#E6E2E1"
																	class="style2" style="background-repeat: no-repeat">&nbsp;&nbsp;&nbsp;Temporal
																	Score Metrics</td>
															</tr>
															<tr>
																<td style="padding-left: 5px;"><table width="100%"
                                      ...
                                      <?php create_cvss_dropdown("Exploitability", NULL, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('ExploitabilityHelp');"></td>
																					</tr>
																				</table></td>
																		</tr>
																		<tr>
                                      ...
                                      <?php create_cvss_dropdown("RemediationLevel", NULL, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('RemediationLevelHelp');"></td>
																					</tr>
																				</table></td>
																		</tr>
																		<tr>
                                      ...
                                      <?php create_cvss_dropdown("ReportConfidence", NULL, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('ReportConfidenceHelp');"></td>
																					</tr>
																				</table></td>
																		</tr>
																	</table></td>
															...
															<tr bordercolor="#CCCCCC">
																<td background="../images/cal-bg.jpg" class="style2"><span
																	class="style2" style="background-repeat: no-repeat">&nbsp;&nbsp;&nbsp;Environmental
																		Score Metrics</span></td>
															</tr>
															<tr>
																<td style="padding-left: 5px;"><table width="100%"
																		border="0" cellspacing="1" cellpadding="1">
                                      ...
                                      <?php create_cvss_dropdown("CollateralDamagePotential", NULL, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('CollateralDamagePotentialHelp');" /></td>
																					</tr>
																				</table></td>
																		</tr>
																		<tr>
                                      ...
                                      <?php create_cvss_dropdown("TargetDistribution", NULL, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('TargetDistributionHelp');" /></td>
																					</tr>
																				</table></td>
																		</tr>
																		<tr>
																			<td colspan="2" class="style1"><strong>Impact
																					Subscore Modifiers</strong></td>
																		</tr>
																		<tr>
                                      ...
                                      <?php create_cvss_dropdown("ConfidentialityRequirement", NULL, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('ConfidentialityRequirementHelp');" /></td>
																					</tr>
																				</table></td>
																		</tr>
																		<tr>
                                      ...
                                      <?php create_cvss_dropdown("IntegrityRequirement", NULL, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('IntegrityRequirementHelp');" /></td>
																					</tr>
																				</table></td>
																		</tr>
																		<tr>
                                      ...
                                      <?php create_cvss_dropdown("AvailabilityRequirement", NULL, false)?>
																						...
																						<td><img src="../images/helpicon.jpg" width="25"
																							height="18" align="absmiddle"
																							onClick="javascript:showHelp('AvailabilityRequirementHelp');" /></td>
																					</tr>
																				</table></td>
																		</tr>
																	</table></td>
...
--> <input type="button" name="cvssSubmit" id="cvssSubmit"
														value="Submit" onclick="javascript: submitandclose();" />
													</td>
												</tr>
												<tr>
