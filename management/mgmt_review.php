...
if (isset ( $_GET ['id'] ) || isset ( $_POST ['id'] )) {
	...
	// If the risk level is critical and they have permission
	if (($risk_level == "Critical") && ($_SESSION ['review_critical'] == 1)) {
		// Review is approved
		$approved = true;
...
if (isset ( $_POST ['submit'] )) {
	...
	if ($approved) {
		...
		// Submit review
		if (submit_management_review ( $id, $status, $review, $next_step, $reviewer, $comments )){
			// Audit log
			$risk_id = $id;
			...
			<div class="row-fluid">
				<div class="span3">
					<ul class="nav  nav-pills nav-stacked">
						...
						<li class="active"><a href="management_review.php">III. <?php echo $lang['PerformManagementReviews']; ?></a>
						</li>
