...
// Check if the user is HackLabs Staff (1) or HackLabs Client (2) and has permission to submit mititgations
...
if ((isset ( $_GET ['id'] ) || isset ( $_POST ['id'] ))) {
	...
	//If a HackLabs client, requesting to see the specific risk details, has privileges to see the risk
...
if ((isset ( $_POST ['submit'] )) && $plan_mitigations) {
	...
	// Submit mitigation
	if (!submit_mitigation ( $id, $status, $planning_strategy, $mitigation_effort, $current_solution, $security_requirements, $security_recommendations )){
		$alert = "bad";
		$alert_message = "There where an issue with the DB after the attempt to update the content. Please try again.";
			...
			<div class="row-fluid">
				<div class="span3">
					<ul class="nav  nav-pills nav-stacked">
						...
						<li class="active"><a href="plan_mitigations.php">II. <?php echo $lang['PlanYourMitigations']; ?></a>
						</li>
              ...
              <?php view_top_table($id, $calculated_risk, $subject, $status, true); ?>
                ...
                <?php edit_mitigation_submission($planning_strategy, $mitigation_effort, $current_solution, $security_requirements, $security_recommendations); ?>
					...
					<div class="row-fluid">
						<div class="span6">
							<div class="well">
		<?php view_risk_details($submission_date, $subject, $reference_id, $regulation, $control_number, $location, $team, $technology, $owner, $manager,$description, $impact, $detail, $host_url, $recommendation, $assessment, $notes); ?>
              </div>
						</div>
						<div class="span6">
							<div class="well">
