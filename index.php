...
if (isset ( $_POST ['submit'] ) || isset ( $_POST ['yubikey'] )) {
	$user = $_POST ['user'];
	$pass = $_POST ['pass'];
	$key = (isset ( $_POST ['key'] ) ? $_POST [ 'key'] : null ); 
	
	// If the user is valid
	if (is_valid_user ( $user, $pass , $key )) {
...
<title>R2MS: Risk and Reporting Management Service</title>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span9">
					<div class="hero-unit">
						<center>
							<img src="images/hackLabs.png" />
							<p>Reporting & Risk Management Service (R<sup>2</sup>MS)</p>
						</center>
					</div>
				</div>
			</div>
...
if (isset ( $_SESSION ["access"] ) && $_SESSION ["access"] == "duo") {
	...
	echo $lang ['Username'] . ": <input class=\"input-medium\" name=\"user\" id=\"user\" type=\"text\" autofocus=\"autofocus\"/><br />\n";
	echo $lang ['Password'] . ": <input class=\"input-medium\" name=\"pass\" id=\"pass\" type=\"password\" autocomplete=\"off\" />\n";
//<input class="span11" autocomplete="off" type="text" name="key" placeholder="YubiKey" autofocus="autofocus">
	echo "&nbsp;YubiKey" . ": <input class=\"input-medium\" autocomplete=\"off\" type=\"password\" name=\"key\" placeholder=\"YubiKey\" />\n";
	echo "<label><a href=\"reset.php\">" . $lang ['ForgotYourPassword'] . "</a></label>\n";
	echo "<div class=\"form-actions\">\n";
	echo "<button type=\"submit\" name=\"submit\" class=\"btn btn-primary\" style=\"display:none;\">" . $lang ['Login'] . "</button>\n";
