...
if (isset ($_SESSION ["type"]) && $_SESSION ["type"] == 2 && isset($_SESSION['company']) && is_int ((int)$_SESSION['company']) && existNameByValue('company', $_SESSION['company'])) {
...
<script src="../js/reports/projects_and_risks.js"></script>
...
?>
			...
			<div class="row-fluid">
				<div class="span3">
					<ul class="nav  nav-pills nav-stacked">
						...
						<li class="active"><a href="projects_and_risks.php"><?php echo $lang['ProjectsAndRisksAssigned']; ?></a>
						</li>
					</ul>
				</div>
				<div class="span9">
					<div class="row-fluid">
						<p><?php echo $lang['ReportProjectsAndRisksHelp']; ?>.</p>
	  ...
	  <?php get_projects_and_risks_table(1); ?>
        </div>
			</div>
		</div>
