...
<script src="../js/reports/risk_scoring.js"></script>
			...
			<div class="row-fluid">
				<div class="span3">
					<ul class="nav  nav-pills nav-stacked">
						...
						<li class="active"><a href="risk_scoring.php"><?php echo $lang['AllOpenRisksByScoringMethod']; ?></a>
						</li>
				...
				<div class="span9">
					<div class="row-fluid">
						<p><?php echo $lang['ReportRiskScoringHelp']; ?>.</p>
