...
<script src="../js/reports/review_needed.js"></script>
			...
			<div class="row-fluid">
				<div class="span3">
					<ul class="nav  nav-pills nav-stacked">
						...
						<li class="active"><a href="review_needed.php"><?php echo $lang['AllOpenRisksNeedingReview']; ?></a>
						</li>
				...
				<div class="span9">
					<div class="row-fluid">
						<p><?php echo $lang['ReportReviewNeededHelp']; ?>.</p>
