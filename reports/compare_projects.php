...
<script src="../js/reports/compare_projects.js"></script>
			...
			<div class="row-fluid">
				<div class="span3">
					<ul class="nav  nav-pills nav-stacked">
						...
						<li class="active"><a href="compare_projects.php"><?php echo $lang['Compare_projects']; ?></a></li>
				...
				<?php if (isset ( $_SESSION ["type"] ) && $_SESSION ["type"] == "1"){?>
					<tr>
						...
						<td colspan="2"><?php create_dropdown("company",null,null,true,false,true,false); ?></td>
					</tr>								
				<?php } ?>
					<tr>
						<td width="200px"><?php echo $lang['NameProject']; ?>:</td>
						<td colspan="2"><?php create_dropdown(null,null,'project', true, false, true); ?></td>
					</tr>
					<tr>
						<td width="200px"><?php echo $lang['NameProject']; ?>:</td>
						<td colspan="2"><?php create_dropdown(null,null,'project2', true, false, true); ?></td>
					</tr>
					<tr height="50px">
						<td colspan="3"><input id="bcompare" type="button" class="btn btn-primary" value="<?php echo $lang['Compare']; ?>"></td>
					</tr>
				</table>
				</div>
				<div id="alert" class="span9"></div>
				<div class="span9" id="bars" style="visibility: hidden;">
					<h3><?php echo $lang['Compare_projects_title']; ?></h3>
					<div id="compare_open_risk_bar"></div>
				</div>
			</div>
		</div>
