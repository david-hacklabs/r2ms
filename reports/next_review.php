...
<script src="../js/reports/next_review.js"></script>
			...
			<div class="row-fluid">
				<div class="span3">
					<ul class="nav  nav-pills nav-stacked">
						...
						<li class="active"><a href="next_review.php"><?php echo $lang['AllOpenRisksAcceptedUntilNextReviewByRiskLevel']; ?></a>
						</li>
				...
				<div class="span9">
					<div class="row-fluid">
						<div class="span12">
						<p><?php echo $lang['ReportNextReviewHelp']; ?>.</p>
