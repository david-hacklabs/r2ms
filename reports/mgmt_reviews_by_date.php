...
<script src="../js/reports/mgmt_reviews_by_date.js"></script>
			...
			<div class="row-fluid">
				<div class="span3">
					<ul class="nav  nav-pills nav-stacked">
						...
						<li class="active"><a href="mgmt_reviews_by_date.php"><?php echo $lang['ManagementReviewsByDate']; ?></a>
						</li>
						<!-- 
				...
				<div class="span9">
					<div class="row-fluid">
						<p><?php echo $lang['ReportMgmtReviewsByDateHelp']; ?>.</p>
