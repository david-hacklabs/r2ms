...
<script src="../js/reports/trend.js"></script>
			...
			<div class="row-fluid">
				<div class="span3">
					<ul class="nav  nav-pills nav-stacked">
						...
						<li class="active"><a href="trend.php"><?php echo $lang['RiskTrend']; ?></a>
						</li>
				...
				<div class="span9" id="chart" style="visibility:hidden;">
					<div class="row-fluid" id="trend">
            			<?php get_risk_trend(4); ?>
          			</div>
				</div>
			</div>
		</div>
