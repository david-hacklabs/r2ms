			...
			<div class="row-fluid">
				<div class="span3">
					<ul class="nav  nav-pills nav-stacked">
						<li class="active"><a href="index.php"><?php echo $lang['RiskDashboard']; ?></a>
						</li>
						...
						<li><a href="compare_projects.php"><?php echo $lang['Compare_projects']; ?></a></li>
						<li><a href="open.php"><?php echo $lang['AllOpenRisksByRiskLevel']; ?></a>
						</li>
				...
				<div class="span9" id="pies" style="visibility:hidden;">
					<div class="row-fluid">
						<h3><?php echo $lang['OpenRisks']; ?> <span id="n_openrisks"></span></h3>
					</div>
					<div class="row-fluid">
						<div class="span3">
							<div class="well" id="content-open_risk_level_pie">
             				 </div>
						</div>
						<div class="span3">
							<div class="well" id="content-open_risk_status_pie">
             			 	</div>
						</div>
						<div class="span3">
							<div class="well" id="content-open_risk_owner_pie">
			              	</div>
						</div>
						<div class="span3">
							<div class="well" id="content-open_risk_owners_manager_pie">
			              	</div>
						</div>
						<!-- 
						<div class="span3">
							<div class="well" id="content-open_risk_location_pie">
              				</div>
						</div>
						-->
					</div>
					...
					<div class="row-fluid">
						...
						<div class="span3">
							<div class="well" id="content-open_risk_category_pie">
			              </div>
						</div>
						 
						<div class="span3">
							<div class="well" id="content-open_risk_team_pie">
			            	</div>
						</div>
						<div class="span3">
							<div class="well" id="content-open_risk_technology_pie">
			              </div>
						</div>
					</div>
					-->
					<div class="row-fluid">
						...
						<!-- 
						<div class="span3">
							<div class="well" id="content-open_risk_scoring_method_pie">
			              	</div>
						</div>
						-->
					</div>
					<div class="row-fluid">
						<h3><?php echo $lang['ClosedRisks']; ?> <span id="n_closerisks"></span></h3>
					</div>
					<div class="row-fluid">
						<div class="span3">
							<div class="well" id="content-closed_risk_reason_pie">
			              	</div>
						</div>
					</div>
				</div>
