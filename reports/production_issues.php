...
<script src="../js/reports/production_issues.js"></script>
			...
			<div class="row-fluid">
				<div class="span3">
					<ul class="nav  nav-pills nav-stacked">
						...
						<li class="active"><a href="production_issues.php"><?php echo $lang['AllOpenRisksToSubmitAsAProductionIssueByRiskLevel']; ?></a>
						</li>
				...
				<div class="span9">
					<div class="row-fluid">
						<p><?php echo $lang['ReportProductionIssuesHelp']; ?>.</p>
