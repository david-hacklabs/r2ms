...
?>
    <div class="container-fluid">
			<div class="row-fluid">
                ...
                <?php echo $lang['FullName']; ?>: <input
									style="cursor: default;" name="name" type="text" maxlength="50"
									size="20" title="<?php echo $name; ?>" disabled="disabled"
									value="<?php echo $name; ?>" /><br />
                <?php echo $lang['EmailAddress']; ?>: <input
									style="cursor: default;" name="email" type="text"
									maxlength="200" size="20" title="<?php echo $email; ?>"
									disabled="disabled" value="<?php echo $email; ?>" /><br />
                <?php echo $lang['Username']; ?>: <input
									style="cursor: default;" name="username" type="text"
									maxlength="20" size="20" title="<?php echo $username; ?>"
									disabled="disabled" value="<?php echo $username; ?>" /><br />
                <?php echo $lang['LastLogin']; ?>: <input
									style="cursor: default;" name="last_login" type="text"
									maxlength="20" size="20" title="<?php echo $last_login; ?>"
									disabled="disabled" value="<?php echo $last_login; ?>" /><br />
								<form name="change_language" method="post" action="">
		<?php echo $lang['Language']; ?>: <?php create_dropdown("languages", get_value_by_name("languages", $language)); ?><input
										type="submit" name="change_language" value="Update Language" /><br />
								</form>
								<h6>
