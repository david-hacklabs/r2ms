...
if (isset ( $_POST ['delete_category'] )) {
	...
	if (is_int ( $value )) {
		if (delete_value ( "category", $value )){
			// Audit log
			$risk_id = 1000;
...
// Check if a new Type of User was submitted
if (isset ( $_POST ['add_typeuser'] )) {
	$name = $_POST ['new_typeuser'];
	
	// Insert a new category up to 50 chars
	if (add_name ( "typeuser", $name, 50 )){
		// Audit log
		$risk_id = 1000;
		$message = "A new type of user was added by the \"" . $_SESSION ['user'] . "\" user.";
		write_log ( $risk_id, $_SESSION ['uid'], $message );
		
		// There is an alert message
		$alert = "good";
		$alert_message = "A new type of user was added successfully.";
	}
	else {
		$alert = "bad";
		$alert_message = "There where an issue with the DB after the attempt to update the content. Please try again.";
...
// Check if a Type of User was deleted
if (isset ( $_POST ['delete_typeuser'] )) {
	$value = ( int ) $_POST ['typeuser'];
	
	// Verify value is an integer
	if (is_int ( $value )) {
		if (delete_value ( "typeuser", $value )){
			// Audit log
			$risk_id = 1000;
			$message = "An existing type of user was removed by the \"" . $_SESSION ['user'] . "\" user.";
			write_log ( $risk_id, $_SESSION ['uid'], $message );
			
			// There is an alert message
			$alert = "good";
			$alert_message = "An existing type of user was removed successfully.";
		}
		else {
			// There is an alert message
			$alert = "bad";
...
if (isset ( $_POST ['add_technology'] )) {
	...
	if (add_name ( "technology", $name, 50 )){
		// Audit log
		$risk_id = 1000;
...
if (isset ( $_POST ['delete_technology'] )) {
	...
	// Verify value is an integer
	if (is_int ( $value )) {
		if (delete_value ( "technology", $value )){
			// Audit log
			$risk_id = 1000;
...
if (isset ( $_POST ['delete_location'] )) {
	...
	// Verify value is an integer
	if (is_int ( $value )) {
		if (delete_value ( "location", $value )){
			// Audit log
			$risk_id = 1000;
...
if (isset ( $_POST ['add_regulation'] )) {
	...
	if(add_name ( "regulation", $name, 50 )){
		// Audit log
		$risk_id = 1000;
...
if (isset ( $_POST ['delete_regulation'] )) {
	...
	// Verify value is an integer
	if (is_int ( $value )) {
		if (delete_value ( "regulation", $value )){
			// Audit log
			$risk_id = 1000;
...
if (isset ( $_POST ['add_planning_strategy'] )) {
	...
	if (add_name ( "planning_strategy", $name, 20 )){
		// Audit log
		$risk_id = 1000;
...
if (isset ( $_POST ['delete_planning_strategy'] )) {
	...
	// Verify value is an integer
	if (is_int ( $value )) {
		if (delete_value ( "planning_strategy", $value )){
			// Audit log
			$risk_id = 1000;
...
if (isset ( $_POST ['add_close_reason'] )) {
	...
	if (add_name ( "close_reason", $name, 50 )){
		// Audit log
		$risk_id = 1000;
...
if (isset ( $_POST ['delete_close_reason'] )) {
	...
	// Verify value is an integer
	if (is_int ( $value )) {
		if (delete_value ( "close_reason", $value )){
			// Audit log
			$risk_id = 1000;
		...
		<div class="row-fluid">
			<div class="span3">
				<ul class="nav  nav-pills nav-stacked">
					...
					<li class="active"><a href="add_remove_values.php"><?php echo $lang['AddAndRemoveValues']; ?></a>
					</li>
			...
			<div class="span9">
                ...
                <?php echo $lang['AddNewCategoryNamed']; ?> <input
									name="new_category" type="text" maxlength="50" size="20" />&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Add']; ?>"
									name="add_category" /><br />
                <?php echo $lang['DeleteCurrentCategoryNamed']; ?> <?php create_dropdown("category"); ?>&nbsp;&nbsp;<input
						...
						<div class="hero-unit">
							<form name="typeuser" method="post" action="">
								<p>
								
								<h4><?php echo $lang['TypeUser']; ?>:</h4>
                <?php echo $lang['AddNewTypeUserNamed']; ?> <input
									name="new_typeuser" type="text" maxlength="50" size="20" />&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Add']; ?>"
									name="add_typeuser" /><br />
                <?php echo $lang['DeleteTypeUserNamed']; ?> <?php create_dropdown("typeuser"); ?>&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Delete']; ?>"
									name="delete_typeuser" />
								</p>
							</form>
						</div>
                ...
                <?php echo $lang['AddNewTeamNamed']; ?> <input
									name="new_team" type="text" maxlength="50" size="20" />&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Add']; ?>"
									name="add_team" /><br />
                <?php echo $lang['DeleteCurrentTeamNamed']; ?> <?php create_dropdown("team"); ?>&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Delete']; ?>"
									name="delete_team" />
								</p>
							</form>
                ...
                <?php echo $lang['AddNewTechnologyNamed']; ?> <input
									name="new_technology" type="text" maxlength="50" size="20" />&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Add']; ?>"
									name="add_technology" /><br />
                <?php echo $lang['DeleteCurrentTechnologyNamed']; ?> <?php create_dropdown("technology"); ?>&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Delete']; ?>"
                ...
                <?php echo $lang['AddNewSiteLocationNamed']; ?> <input
									name="new_location" type="text" maxlength="100" size="20" />&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Add']; ?>"
									name="add_location" /><br />
                <?php echo $lang['DeleteCurrentSiteLocationNamed']; ?> <?php create_dropdown("location"); ?>&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Delete']; ?>"
                ...
                <?php echo $lang['AddNewControlRegulationNamed']; ?> <input
									name="new_regulation" type="text" maxlength="50" size="20" />&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Add']; ?>"
									name="add_regulation" /><br />
                <?php echo $lang['DeleteCurrentControlRegulationNamed']; ?> <?php create_dropdown("regulation"); ?>&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Delete']; ?>"
                ...
                <?php echo $lang['AddNewRiskPlanningStrategyNamed']; ?> <input
									name="new_planning_strategy" type="text" maxlength="20"
									size="20" />&nbsp;&nbsp;<input type="submit"
									value="<?php echo $lang['Add']; ?>"
									name="add_planning_strategy" /><br />
                <?php echo $lang['DeleteCurrentRiskPlanningStrategyNamed']; ?> <?php create_dropdown("planning_strategy"); ?>&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Delete']; ?>"
									name="delete_planning_strategy" />
								</p>
							</form>
						</div>
						<div class="hero-unit">
                ...
                <?php echo $lang['AddNewCloseReasonNamed']; ?> <input
									name="new_close_reason" type="text" maxlength="20" size="20" />&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Add']; ?>"
									name="add_close_reason" /><br />
                <?php echo $lang['DeleteCurrentCloseReasonNamed']; ?> <?php create_dropdown("close_reason"); ?>&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Delete']; ?>"
									name="delete_close_reason" />
								</p>
							</form>
						</div>
					</div>
