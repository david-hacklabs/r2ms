...
if (isset ( $_POST ['update_review_settings'] )) {
	$critical = ( int ) $_POST ['critical'];
	$high = ( int ) $_POST ['high'];
	$medium = ( int ) $_POST ['medium'];
	$low = ( int ) $_POST ['low'];
	
	// Check if all values are integers
	if (is_int($critical) && is_int ( $high ) && is_int ( $medium ) && is_int ( $low )) {
		// Update the review settings
		if (update_review_settings ( $critical, $high, $medium, $low )){
			// Audit log
			$risk_id = 1000;
			...
			$alert = "bad";
			$alert_message = "There were an issue with the DB after the attempt to update the content.  Please try again.";
		}
		...
		<div class="row-fluid">
			<div class="span3">
				<ul class="nav  nav-pills nav-stacked">
					...
					<li class="active"><a href="review_settings.php"><?php echo $lang['ConfigureReviewSettings']; ?></a>
					</li>
	        ...
	        <?php $review_levels = get_review_levels(); ?>
				 ...
				 <p><?php echo $lang['IWantToReviewCriticalRiskEvery']; ?> <input
										type="text" name="critical" size="2"
										value="<?php echo $review_levels[0]['value']; ?>" /> <?php echo $lang['days']; ?>.</p>	
                <p><?php echo $lang['IWantToReviewHighRiskEvery']; ?> <input
										type="text" name="high" size="2"
										value="<?php echo $review_levels[1]['value']; ?>" /> <?php echo $lang['days']; ?>.</p>
								<p><?php echo $lang['IWantToReviewMediumRiskEvery']; ?> <input
										type="text" name="medium" size="2"
										value="<?php echo $review_levels[2]['value']; ?>" /> <?php echo $lang['days']; ?>.</p>
								<p><?php echo $lang['IWantToReviewLowRiskEvery']; ?> <input
										type="text" name="low" size="2"
										value="<?php echo $review_levels[3]['value']; ?>" /> <?php echo $lang['days']; ?>.</p>

								<input type="submit" value="<?php echo $lang['Update']; ?>"
									name="update_review_settings" />
