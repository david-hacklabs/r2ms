...
if (isset ( $_POST ['update_impact'] )) {
	...
	if (is_int ( $value )) {
		if (update_table ( "impact", $new_name, $value )){
			// Audit log
			$risk_id = 1000;
...
if (isset ( $_POST ['update_likelihood'] )) {
	...
	// Verify value is an integer
	if (is_int ( $value )) {
		if (update_table ( "likelihood", $new_name, $value )){
			// Audit log
			$risk_id = 1000;
...
if (isset ( $_POST ['update_mitigation_effort'] )) {
	...
	// Verify value is an integer
	if (is_int ( $value )) {
		if (update_table ( "mitigation_effort", $new_name, $value )){
		...
		<div class="row-fluid">
			<div class="span3">
				<ul class="nav  nav-pills nav-stacked">
					...
					<li class="active"><a href="custom_names.php"><?php echo $lang['RedefineNamingConventions']; ?></a>
					</li>
			...
			<div class="span9">
                ...
                <?php echo $lang['Change']; ?> <?php create_dropdown("impact") ?> <?php echo $lang['to']; ?> <input
									name="new_name" type="text" size="20" />&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Update']; ?>"
									name="update_impact" />
								</p>
							</form>
						</div>
                ...
                <?php echo $lang['Change']; ?> <?php create_dropdown("likelihood") ?> <?php echo $lang['to']; ?> <input
									name="new_name" type="text" size="20" />&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Update']; ?>"
									name="update_likelihood" />
								</p>
							</form>
						</div>
						<div class="hero-unit">
                ...
                <?php echo $lang['Change']; ?> <?php create_dropdown("mitigation_effort") ?> <?php echo $lang['to']; ?> <input
									name="new_name" type="text" size="20" />&nbsp;&nbsp;<input
									type="submit" value="<?php echo $lang['Update']; ?>"
									name="update_mitigation_effort" />
								</p>
							</form>
						</div>
					</div>
