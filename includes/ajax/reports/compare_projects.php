...
if (! isset ( $_SESSION ["access"] ) || $_SESSION ["access"] != "granted") {
	...
	$risk_id = 1000;
	$message = "An AJAX request to get comprare project into a Bar Char fail by the \"" . $_SESSION ['user'] . "\" user.";
...
if (isset($_GET['project']) && is_int ((int)$_GET['project']) && isset($_GET['project2']) && is_int ((int)$_GET['project2'])){
	$project = (int) $_GET['project'];
	$project2 = (int) $_GET['project2'];
}
...
if (isset($company) && existNameByValue('company', $company) && isset($project) && existNameByValue('project_version', $project) && isset($project2) && existNameByValue('project_version', $project2)){
	if (!projectversion_exist_in_company($project, $company) || !projectversion_exist_in_company($project2, $company)){
		...
		$return->message->compare_open_risk_bar = compare_open_risk_bar($project, $project2);
		$return->success = true;
