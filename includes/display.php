...
function view_top_table($id, $calculated_risk, $subject, $status, $show_details = false) {
	...
	echo "</tr>\n";
	echo "<tr>\n";
	echo "<td width=\"100\"><h4>" . $lang ['Project'] . ":</h4></td>\n";
	echo "<td><h4>" . getProjectDetailsByRisk($id) . "</h4></td>\n";
	echo "</tr>\n";
	echo "</table>\n";
 ...
 * *****************************
 */
function view_risk_details($submission_date, $subject, $reference_id, $regulation, $control_number, $location, $team, $technology, $owner, $manager, $description, $impact, $detail, $host_url, $recommendation, $assessment, $notes) {
	global $lang;
	...
	*/
	...
	echo "<br />\n";
	echo "<textarea style=\"cursor: default;\" name=\"description\" cols=\"50\" rows=\"3\" id=\"description\" title=\"" . $description . "\" disabled=\"disabled\">" . $description . "</textarea>\n";
	echo "<br />\n";
	echo $lang ['Impact'] . ": \n";
	echo "<br />\n";
	echo "<textarea style=\"cursor: default;\" name=\"impact\" cols=\"50\" rows=\"3\" id=\"impact\" title=\"" . $impact . "\" disabled=\"disabled\">" . $impact . "</textarea>\n";
	echo "<br />\n";
	echo $lang ['Detail'] . ": \n";
	echo "<br />\n";
	echo "<textarea style=\"cursor: default;\" name=\"detail\" cols=\"50\" rows=\"3\" id=\"detail\" title=\"" . $detail . "\" disabled=\"disabled\">" . $detail . "</textarea>\n";
	echo "<br />\n";
	echo $lang ['host_url'] . ": \n";
	echo "<br />\n";
	echo "<input style=\"cursor: default;\" type=\"text\" name=\"host_url\" id=\"host_url\" size=\"50\" value=\"" . $host_url . "\" title=\"" . $host_url . "\" disabled=\"disabled\" />\n";
	echo "<br />\n";
	echo $lang ['Recommendation'] . ": \n";
	echo "<br />\n";
	echo "<textarea style=\"cursor: default;\" name=\"recommendation\" cols=\"50\" rows=\"3\" id=\"recommendation\" title=\"" . $recommendation . "\" disabled=\"disabled\">" . $recommendation . "</textarea>\n";
	echo "<br />\n";
 ...
 * *****************************
 */
function edit_risk_details($submission_date, $subject, $reference_id, $regulation, $control_number, $location, $team, $technology, $owner, $manager, $description, $impact, $detail, $host_url, $recommendation, $CLASSIC_likelihood, $CLASSIC_impact, $AccessVector, $AccessComplexity, $Authentication, $ConfImpact, $IntegImpact, $AvailImpact, $Exploitability, $RemediationLevel, $ReportConfidence, $CollateralDamagePotential, $TargetDistribution, $ConfidentialityRequirement, $IntegrityRequirement, $AvailabilityRequirement, $DREADDamagePotential, $DREADReproducibility, $DREADExploitability, $DREADAffectedUsers, $DREADDiscoverability, $OWASPSkillLevel, $OWASPMotive, $OWASPOpportunity, $OWASPSize, $OWASPEaseOfDiscovery, $OWASPEaseOfExploit, $OWASPAwareness, $OWASPIntrusionDetection, $OWASPLossOfConfidentiality, $OWASPLossOfIntegrity, $OWASPLossOfAvailability, $OWASPLossOfAccountability, $OWASPFinancialDamage, $OWASPReputationDamage, $OWASPNonCompliance, $OWASPPrivacyViolation, $custom, $assessment, $notes) {
	global $lang;
	
	echo "<h4>" . $lang ['Details'] . "</h4>\n";
	echo $lang ['SubmissionDate'] . ": \n";
	echo "</br><input style=\"cursor: default;\" type=\"text\" name=\"submission_date\" id=\"submission_date\" size=\"50\" value=\"" . $submission_date . "\" title=\"" . $submission_date . "\" disabled=\"disabled\" />\n";
	echo "<br />\n";
	echo $lang ['Subject'] . ":</br><input type=\"text\" name=\"subject\" id=\"subject\" size=\"50\" value=\"" . $subject . "\" />\n";
	echo "<br />\n";
	echo $lang ['ExternalReferenceId'] . ": </br><input type=\"text\" name=\"reference_id\" id=\"reference_id\" size=\"20\" value=\"" . $reference_id . "\" />\n";
	echo "<br />\n";
	echo $lang ['ControlRegulation'] . ": \n";
	create_dropdown ( "regulation", $regulation );
	echo "<br />\n";
	echo $lang ['ControlNumber'] . ": </br><input type=\"text\" name=\"control_number\" id=\"control_number\" size=\"20\" value=\"" . $control_number . "\" />\n";
	echo "<br />\n";
	/*
	echo $lang ['SiteLocation'] . ": \n";
	echo "<br />\n";	
	...
	*/
	...
	echo $lang ['Description'] . ": \n";
	echo "<br />\n";
	echo "<textarea style=\"cursor: default;\" name=\"description\" cols=\"50\" rows=\"3\" id=\"description\" title=\"" . $description . "\" >" . $description . "</textarea>\n";
	echo "<br />\n";
	echo $lang ['Impact'] . ": \n";
	echo "<br />\n";
	echo "<textarea style=\"cursor: default;\" name=\"impact\" cols=\"50\" rows=\"3\" id=\"impact\" title=\"" . $impact . "\" >" . $impact . "</textarea>\n";
	echo "<br />\n";
	echo $lang ['Detail'] . ": \n";
	echo "<br />\n";
	echo "<textarea style=\"cursor: default;\" name=\"detail\" cols=\"50\" rows=\"3\" id=\"detail\" title=\"" . $detail . "\" >" . $detail . "</textarea>\n";
	echo "<br />\n";
	echo $lang ['host_url'] . ": <input type=\"text\" name=\"host_url\" id=\"host_url\" size=\"20\" value=\"" . $host_url . "\" />\n";
	echo "<br />\n";
	echo $lang ['Recommendation'] . ": \n";
	echo "<br />\n";
	echo "<textarea style=\"cursor: default;\" name=\"recommendation\" cols=\"50\" rows=\"3\" id=\"recommendation\" title=\"" . $recommendation . "\" >" . $recommendation . "</textarea>\n";
	echo "<br />\n";
	echo $lang ['RiskAssessment'] . ": \n";
	echo "<br />\n";
...
function edit_custom_score($custom) {
	...
	echo "<td width=\"60\"><input type=\"number\" name=\"Custom\" id=\"Custom\" min=\"1\" max=\"5\" style=\"width:30px;\" value=\"" . $custom . "\"></td>\n";
	echo "<td>(Must be a numeric value between 1 and 5)</td>\n";
	echo "</tr>\n";
...
function classic_scoring_table($id, $calculated_risk, $CLASSIC_likelihood, $CLASSIC_impact) {
	...
	echo "<li><a href=\"view.php?id=" . $id . "&scoring_method=5\">" . $lang ['ScoreBy'] . " HackLabs Risk Formula</a></li>\n";
	echo "</ul>\n";
	echo "</div>\n";
	echo "</td>\n";
	echo "</tr>\n";
...
function cvss_scoring_table($id, $calculated_risk, $AccessVector, $AccessComplexity, $Authentication, $ConfImpact, $IntegImpact, $AvailImpact, $Exploitability, $RemediationLevel, $ReportConfidence, $CollateralDamagePotential, $TargetDistribution, $ConfidentialityRequirement, $IntegrityRequirement, $AvailabilityRequirement) {
	...
	echo "<li><a href=\"view.php?id=" . $id . "&scoring_method=5\">Score by HackLabs Risk Formula</a></li>\n";
	echo "</ul>\n";
	echo "</div>\n";
	echo "</td>\n";
	echo "</tr>\n";
...
function custom_scoring_table($id, $custom) {
	...
	echo "<tr>\n";
	echo "<td colspan=\"2\"><h4>HackLabs Risk Rate</h4></td>\n";
	echo "<td colspan=\"1\" style=\"vertical-align:top;\">\n";
	echo "<div class=\"btn-group pull-right\">\n";
	echo "<a class=\"btn dropdown-toggle\" data-toggle=\"dropdown\" href=\"#\">Risk Scoring Actions<span class=\"caret\"></span></a>\n";
	echo "<ul class=\"dropdown-menu\">\n";
	echo "<li><a href=\"#\" onclick=\"javascript:updateScore()\">Update HackLabs Rate</a></li>\n";
	echo "<li><a href=\"view.php?id=" . $id . "&scoring_method=1\">Score by Classic</a></li>\n";
	echo "<li><a href=\"view.php?id=" . $id . "&scoring_method=2\">Score by CVSS</a></li>\n";
	echo "<li><a href=\"view.php?id=" . $id . "&scoring_method=3\">Score by DREAD</a></li>\n";
	echo "<li><a href=\"view.php?id=" . $id . "&scoring_method=4\">Score by OWASP</a></li>\n";
