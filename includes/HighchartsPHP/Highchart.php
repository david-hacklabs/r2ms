...
class Highchart implements ArrayAccess {
	 ...
	 *
	 * @param int $chartType
	 *        	The chart type (Either self::HIGHCHART or self::HIGHSTOCK)
	 * @param int $jsEngine
	 *        	The javascript library to use
	 *        	(One of ENGINE_JQUERY, ENGINE_MOOTOOLS or ENGINE_PROTOTYPE)
	 */
	 ...
	 *        	The javascript chart variable name
	 * @param string $callback
	 *        	The function callback to pass
	...
	/**
	 * Return javascript script tags for all scripts that need to be included on page
	 */
	public function printScripts2() {
		$returnhtml='';
		foreach ( $this->getScripts () as $script ) {
			$returnhtml.='<script type="text/javascript" src="' . $script . '"></script>';
		}
		return $returnhtml;
	}
	 ...
	 *
	 * @param
	 *        	HighchartOption The options to create
	 *        	
